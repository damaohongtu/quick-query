              ...
              <el-row>
                <div v-for="(item, index) in itemData.configInfo.outputField" :key="index">
                  <el-row>
                    ...
                    <el-col :span="7">
                      <el-select v-model="itemData.configInfo.outputField[index].type" size="mini">
                        <el-option>string</el-option>
                        <el-option>int</el-option>
                      </el-select>
                    </el-col>
                    <el-col :span="3">
          ...
          <el-collapse-item title="输入字段配置">
            ...
            <el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-select v-model="itemData.configInfo.inputField.type" size="mini">
                    <el-option>string</el-option>
                    <el-option>int</el-option>
                  </el-select>
                </el-col>
                ...
                <el-col :span="24">
                  <el-form label-width="80px">
                    <el-form-item label="Database:">
                      <el-select v-model="itemData.configInfo.dataSource.dataSource" size="mini">
                        <el-option
                ...
                <el-col>
                  <el-form label-width="80px">
                    <el-form-item label="Table:">
                      <el-input v-model="itemData.configInfo.dataSource.table" placeholder="请输入" size="mini" />
                    </el-form-item>
                  </el-form>
                </el-col>
              </el-row>
