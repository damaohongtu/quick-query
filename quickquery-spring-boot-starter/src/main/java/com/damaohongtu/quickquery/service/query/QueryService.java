package com.damaohongtu.quickquery.service.query;
...
import com.damaohongtu.quickquery.dto.graph.RelationDto;
import com.damaohongtu.quickquery.enums.QuickQueryProcessorEnum;
import com.damaohongtu.quickquery.util.SpringUtil;
import com.damaohongtu.quickquery.processor.QueryProcessor;
...
public class QueryService {
     ...
     * @param context
     */
    public void query(QuickQueryContext context){
    ...
    private void traversal(QuickQueryContext context, String nodeCode, Condition condition) {
        // 1. 获取入口节点
     ...
     * @return
     */
    private List<Object> genConditions(QuickQueryContext context, RelationDto relationDto) {
    ...
    private List<List<Element>> fetchData(NodeDto nodeDTO, Condition condition)  {
        ...
        Class clazz = null;
        try {
            clazz = Class.forName(QuickQueryProcessorEnum.codeOf(nodeType).getQueryProcessor());
