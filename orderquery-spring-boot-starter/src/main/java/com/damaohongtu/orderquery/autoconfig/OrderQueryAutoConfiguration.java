package com.damaohongtu.orderquery.autoconfig;

import com.alibaba.druid.pool.DruidDataSource;
import com.damaohongtu.orderquery.autoconfig.property.OrderQueryConfig;
import com.damaohongtu.orderquery.autoconfig.property.OrderQueryDataSourceConfig;
import com.damaohongtu.orderquery.autoconfig.property.ClickHouseProperty;
import com.damaohongtu.orderquery.autoconfig.property.HiveProperty;
import com.damaohongtu.orderquery.autoconfig.property.MysqlProperty;
 ...
 */
@Configuration
@EnableConfigurationProperties(value = {OrderQueryConfig.class, OrderQueryDataSourceConfig.class})
public class OrderQueryAutoConfiguration {
    ...
    public DruidDataSource internalDruidDataSource(OrderQueryConfig config) {
    ...
    public Map<String, List<DruidDataSource>> externalDruidDataSourceMap(OrderQueryDataSourceConfig config){
    ...
    public Map<String, ClickHouseDataSource> externalClickHouseDataSourceMap(OrderQueryDataSourceConfig config){
    ...
    public Map<String, DruidDataSource> externalHiveDataSourceMap(OrderQueryDataSourceConfig config){
