...
public class ShardingExample {
    ...
    public ShardingExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public ShardingExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public ShardingExample page(Integer page, Integer pageSize) {
